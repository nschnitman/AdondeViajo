...
<!-- Stylesheets
	...
	<!-- Document Title
	============================================= -->
	<title>Home - Empresas | <?=$longnombre;?></title>
			...
			<div class="slider-parallax-inner">
				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide" style="background-image: url('../images/slider/swiper/3.jpg');">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									<h2 data-caption-animate="fadeInUp">Bienvenidos a Adonde Viajo</h2>
		...
		<div id="page-menu">
			...
			<div id="page-menu-wrap">
				...
				<div class="container clearfix">
					...
					<div class="menu-title">Explora <span>Adonde Viajo</span></div>

					<nav class="one-page-menu">
						<ul>
							<li><a href="#" data-href="#header"><div>Inicio</div></a></li>
							<li><a href="#" data-href="#section-about"><div>Acerca Nuestro</div></a></li>
							<li><a href="#" data-href="#section-work"><div>Viajes</div></a></li>
						...
						<!-- 	<li><a href="#" data-href="#section-testimonials" class="no-offset"><div>Testimonials</div></a></li> -->
							<li><a href="#" data-href="#section-contact"><div>Contactanos</div></a></li>
						</ul>
					</nav>
			...
			<div class="content-wrap">
				...
				<section id="section-about" class="page-section">
					...
					<div class="container clearfix">
						...
						<div class="heading-block center">
							<h2>Somos <span>Adonde Viajo</span></h2>
							<span>Una empresa destinada a mejorar la experiencia en inscripciones de viajes</span>
						</div>
						...
						<div class="col_one_third nobottommargin">
							<div class="feature-box media-box">
								...
								<div class="fbox-desc">
									<h3>Porque elegirnos?.<span class="subtitle">Porque somos confiables.</span></h3>
														<p>
							Somos una empresa destinada a contribuir en la planificacion y decision de viajes para jovenes judios, brindando asesoramiento y plasmando los alternativos destinos a elegir.</p>
						...
						<div class="col_one_third nobottommargin">
							<div class="feature-box media-box">
								...
								<div class="fbox-desc">
									<h3>Nuestra mision?.<span class="subtitle">Conectarte con un nuevo segmento.</span></h3>
									<p>Buscamos conectar a estos jovenes con sus raices, brindando aportes educativos e historicos, para vivir experiencias inolvidables.</p>
								</div>
							</div>
						</div>
						...
						<div class="col_one_third nobottommargin col_last">
							<div class="feature-box media-box">
								...
								<div class="fbox-desc">
									<h3>Que hacemos?.<span class="subtitle">A nuestros clientes felice.</span></h3>
									<p>Con una nueva plataforma totalmente responsive y moderna, acercamos a los jovenes de hoy en dia, a los viajes que los conectan con sus raices judias.</p>
								</div>
							</div>
						</div>
					...
					<div class="section dark parallax nobottommargin" style="padding: 80px 0;background-image: url('../images/parallax/1.jpg');" data-stellar-background-ratio="0.3">
						...
						<div class="container clearfix">
							...
							<div class="col_one_third nobottommargin center" data-animate="bounceIn">
								...
								<div class="counter counter-lined"><span data-from="5" data-to="26" data-refresh-interval="7" data-speed="2000"></span>M+</div>
							...
							<div class="col_one_third nobottommargin center" data-animate="bounceIn" data-delay="400">
								...
								<div class="counter counter-lined"><span data-from="1" data-to="35" data-refresh-interval="4" data-speed="2000"></span>*</div>
								<h5>No. de Plantillas</h5>
							</div>
							...
							<div class="col_one_third nobottommargin center col_last" data-animate="bounceIn" data-delay="600">
								...
								<div class="counter counter-lined"><span data-from="60" data-to="600" data-refresh-interval="30" data-speed="2300"></span>+</div>
								<h5>Horas de Programacion</h5>
							</div>
				...
				<section id="section-work" class="page-section topmargin-lg">
					...
					<div class="heading-block center">
						...
						<span>Algunos de los viajes con los que hemos estado trabajando.</span>
					</div>
...
>>>>>>> NS-33-merge-github-viejo-nuevo
				...
				<section id="section-services" class="page-section topmargin-lg">
					...
					<div class="heading-block center bottommargin-lg">
						<h2>Servicios</h2>
						<span>Lista de algunas de las características incluidas en Adonde Viajo.</span>
					</div>
					...
					<div class="container clearfix">
						...
						<div class="col_one_third">
							<div class="feature-box fbox-center fbox-effect nobottomborder" data-animate="fadeIn">
								...
								<h3>Dise&ntilde;o Responsive</h3>
								<p>Potente diseño con funcionalidad de respuesta que se puede adaptar a cualquier tamaño de pantalla.</p>
							</div>
						</div>
						...
						<div class="col_one_third">
							<div class="feature-box fbox-center fbox-effect nobottomborder" data-animate="fadeIn" data-delay="200">
								...
								<p>Todos los datos necesarios para ponerte en contacto con todos los interesados. </p>
							</div>
						</div>
						...
						<div class="col_one_third col_last">
							<div class="feature-box fbox-center fbox-effect nobottomborder" data-animate="fadeIn" data-delay="400">
								...
								<h3>Potente rendimiento</h3>
								<p>Código optimizado que es totalmente personalizable y ofrece un rendimiento rápido sin igual.</p>
							</div>
						</div>
						...
						<div class="col_one_third">
							<div class="feature-box fbox-center fbox-effect nobottomborder" data-animate="fadeIn" data-delay="600">
								...
								<h3>Ideas Brillantes</h3>
								<p>Constantemente actualizando la plataforma, ideando nuevas maneras de conectar y difundir entre la gente.</p>
							</div>
						</div>
						...
						<div class="col_one_third">
							<div class="feature-box fbox-center fbox-effect nobottomborder" data-animate="fadeIn" data-delay="800">
								...
								<p>Campa&ntilde;as de email y Facebook Ads constantes.</p>
							</div>
						</div>
						...
						<div class="col_one_third col_last">
							<div class="feature-box fbox-center fbox-effect nobottomborder" data-animate="fadeIn" data-delay="1000">
								...
								<p>Control completo en cada elemento que proporciona infinitas posibilidades de personalización.</p>
							</div>
						</div>
						...
						<div class="pricing-box pricing-extended bottommargin clearfix">
							...
							<div class="pricing-desc">
								<div class="pricing-title">
									<h3>Que ofrece Adonde Viajo?</h3>
								</div>
								<div class="pricing-features">
									<ul class="clearfix">
										<li><i class="icon-desktop"></i> Reportes Completos</li>
										<li><i class="icon-eye-open"></i> Nuevo Publico</li>
										<li><i class="icon-envelope"></i> Campa&ntilde;as de Email Marketing</li>
										<li><i class="icon-magic"></i> Landing Pages Personalizadas</li>
										<li><i class="icon-mobile"></i> Dise&ntilde;o Responsive</li>
										<li><i class="icon-stack3"></i> Inscripciones Directas</li>
										<li><i class="icon-file2"></i> Listado Completo de Inscriptos</li>
										<li><i class="icon-support"></i> Soporte 24x7</li>
									</ul>
								</div>
							</div>
							...
							<div class="pricing-action-area">
								...
								<div class="pricing-price">
									<span class="price-unit">&dollar;</span>2.000<span class="price-tenure">por mes</span>
								</div>
								<div class="pricing-action">
									<a href="precios.php" class="button button-3d button-xlarge btn-block nomargin">Ver mas</a>
								</div>
							</div>
				...
				<section id="section-contact" class="page-section">
					...
					<div class="heading-block title-center">
						...
						<span>¿Tenes preguntas? Contactate con nosotros.</span>
					</div>
					...
					<div class="container clearfix">
						...
						<div class="col_half">
							...
							<div class="contact-widget">
								...
								<div class="col_one_third col_last">
									<label for="template-contactform-service">Plan</label>
						...
						<div class="col_full nobottommargin clearfix">
							...
							<div class="col_one_third">
								<div class="feature-box fbox-center fbox-bg fbox-plain">
									...
									<h3>Nuestras Oficinas<span class="subtitle">Buenos Aires, Argentina</span></h3>
								</div>
							</div>
							...
							<div class="col_one_third">
								<div class="feature-box fbox-center fbox-bg fbox-plain">
									...
									<h3>Llamanos<span class="subtitle">(+54911) 3691-2268</span></h3>
								</div>
							</div>
							...
							<div class="col_one_third col_last">
								<div class="feature-box fbox-center fbox-bg fbox-plain">
									...
									<h3>Envianos un Email<span class="subtitle">info@adondeviajo.com.ar</span></h3>
								</div>
							</div>
	...
	<script type="text/javascript">
		...
		jQuery('#google-map').gMap({
			address: 'Jeronimo Salguero 2600, Palermo, Buenos Aires, Argentina',
			maptype: 'ROADMAP',
			zoom: 14,
			markers: [
				{
					address: "Jeronimo Salguero 2600, Palermo, Buenos Aires, Argentina",
					html: '<div style="width: 300px;"><h4 style="margin-bottom: 8px;">Hola, somos <span>Adonde Viajo</span></h4><p class="nobottommargin">Somos una empresa destinada a contribuir en la planificacion y decision de viajes para jovenes judios, brindando asesoramiento y plasmando los alternativos destinos a elegir.</p></div>',
					icon: {
